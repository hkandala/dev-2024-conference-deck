...
<Notes>
  <div class="notes">
    ...
    <p>30% ruling</p>
    <p>
      Enterprise Engineering at Meta focuses on building internal tools. The aim
      is to improve the speed and efficiency of metamates by building the right
...
<Notes>
  <div class="notes">
    <p>Dates back to 20 years ago.</p>
    <p>Number of transistors on a chip doubles every two years</p>
    <p>Why no 10GHz processor?</p>
    <p>We achieved 3GHz in early 2000s itself</p>
    <p>Clock speed wall because of power consumption and heat</p>
  </div>
</Notes>
...
<Notes>
  <div class="notes">
    <p>
      Important note that this does not mean we didn't have concurrency before
      that
    </p>
  </div>
</Notes>
...
<Notes>
  <div class="notes">
    ...
    <p>
      Concurerncy provides a way to structure a solution that may be
...
<Notes>
  <div class="notes">
    <p>Webserver on single core vs multiple core</p>
    <p>Recommendation on Rob Pike's talk</p>
  </div>
</Notes>
