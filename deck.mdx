...
<Notes>
  <div className="notes">
    ...
    <p>
      In this 20 minutes talk, we will go over different concurrency models and
      try to high level get an understanding of it.
    </p>
    <p>
    ...
    <p>
      Enterprise Engineering at Meta focuses on solving internal problems. We
      aim to improves the speed and efficiency of metamates by building the
...
<Notes>
  <div className="notes">
    <p>Let me start with a tweet I have come across some time ago.</p>
    <p>
...
<Notes>
  <div className="notes">
    <p>This dates back to about 20 year ago</p>
...
<Notes>
  <div className="notes">
    ...
    <p>
      If you look at the graph, you can see that the clock speed and power has
      plateued around 2004-2005.
    </p>
    <p>
      We have to find a way to make the most of the available resources and
...
<Notes>
  <div className="notes">
    ...
    <p>
      Now, let me give a quick primer on what is concurrency and how it is
    ...
    <p>
      ...
      "simultaneous occurrence" which usually gets lost when we refer something
      as concurrent.
    </p>
    <p>
      So, ket's put it formally, Concurrency is about composing and coordinating
...
<Notes>
  <div className="notes">
    ...
    <p>
      ...
      at once where as paralleism about doing lot of things at once.
    </p>
    <p>
      Concurrency focuses on structure where as parallelism focuses on
      execution.
    </p>
  </div>
</Notes>
...
<Notes>
  <div className="notes">
    ...
    <p>
      And, all of these different models are all about how we handle shared
      mutable state.
    </p>
